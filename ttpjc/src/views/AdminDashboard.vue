  ...
  methods: {
    ...
    async fetchHistory() {
      try {
        ...
        const response = await axios.get('vigilant-smile.railway.internal/admin-history');
    ...
    async updateStatus(id) {
      try {
        const response = await axios.patch(`vigilant-smile.railway.internal/update-status/${id}`);
