  ...
  methods: {
    ...
    async fetchHistory() {
      try {
        ...
        const response = await axios.get('https://backend-vnuy.onrender.com/admin-history');
    ...
    async updateStatus(id) {
      try {
        const response = await axios.patch(`https://backend-vnuy.onrender.com/update-status/${id}`);
